...
(function () {
  ...
  safe(function () {
    ...
    chatOnView(ayaChat, [
      { t: "time", text: "сегодня" },
      { t: "in", text: "Айя, куда поехать отдохнуть в сентябре?" },
      { t: "out", text: "Смотрю вашу карту. Вьетнам — через него проходит ваша линия Венеры ♀: отдых, восстановление, красота. Берите первую половину месяца." },
      { t: "in", text: "А off-line встречу с партнёрами в каком городе лучше провести 28–29 сентября?" },
      { t: "out", text: "Санкт-Петербург. Там ваша линия Юпитера ♃ — признание и рост: запуски, переговоры и выступления ложатся идеально. Для короткой камерной встречи — Казань, линия Солнца ☉." },
